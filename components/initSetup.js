...
import { StatusBar, StyleSheet, Text, View, TouchableOpacity, Image, TextInput, Platform } from "react-native";
    ...
    return (
        <View style={styles.container}>
            ...
            <View style={styles.body}>
                <Text style={styles.info}>Enter your name and an optional profile picture</Text>
                ...
                <TouchableOpacity
                    ...
                    onPress={() => {
                        ...
                        if (name.trim().length > 0) {
                            ...
                            axios.post(`${endPoint}/createUser`, data, {
                                headers: {
